|          Name         | Konstantina |    Ariadni   |  Vasiliki  |
|:---------------------:|:-----------:|:------------:|:----------:|
|       Last Name       |    Panou    | Papanikolaou |  Tsouknida |
|       University      |  ECE - NTUA |  ECE - NTUA  | ECE - NTUA |
| Identification Number |   el20144   |    el20097   |   el20042  |
...
<!-- TOC start -->
- [A) Installation of required python packages](#ainstallation-of-required-python-packages)
- [B) Downloading and connecting the database](#bdownloading-and-connecting-the-database)
- [C) User Interface instructions](#cuser-interface-instructions)
	* [Administrator](#administrator)
	* [Library Operator](#library-operators)
	* [School Members](#school-members-teachers--students)
<!-- TOC end -->
...
•	Query 3.2.3. View the average Ratings per borrower and category (Search criteria: user/category)
...
•	Query 3.2.2. Find all borrowers who own at least one book and have delayed its return. (Search criteria: First Name, Last Name, Delay Days).
...
•	Query 3.3.2. List of all books borrowed by this user: information about all the loans the user has made and their status, where the active ones are displayed on top with their respective due dates.
